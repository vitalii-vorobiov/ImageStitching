...
namespace imageStitcher {
    struct ImageStitcher {
        int keypointsAndDescriptors(std::vector<cv::Mat> &images,
                                    std::vector<std::vector<cv::KeyPoint>> &keypoints,
                                    std::vector<cv::Mat> &descriptors);
        int matchDescriptors(std::vector<std::vector<cv::DMatch>> &descriptorsMatches,
                             cv::BFMatcher bfMatcher,
                             std::vector<std::vector<cv::KeyPoint>>& keypoints,
                             std::vector<cv::Mat>& descriptors);
        int matchedSrcDst(std::vector<std::vector<cv::Point2f>> &matchedSrc,
                          std::vector<std::vector<cv::Point2f>> &matchedDst,
                          std::vector<std::vector<cv::DMatch>> &descriptorsMatches,
                          std::vector<std::vector<cv::KeyPoint>> &keypoints,
                          std::vector<cv::Mat> &images);
        int combineImages(std::vector<std::vector<cv::DMatch>> &descriptorsMatches,
